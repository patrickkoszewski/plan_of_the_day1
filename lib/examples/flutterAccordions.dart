  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Column(children: [
        ListTile(
          title: Text(widget.title,style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
          trailing: IconButton(
            icon: Icon(
        ...
        isOpen
            ? Container(
                ...
                child: Text(widget.content,style: const TextStyle(color: Color.fromARGB(255, 34, 34, 34)),),
              )
            : Container()
      ]),
    );
